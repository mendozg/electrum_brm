...
if [ ! -z "$ELECBUILD_COMMIT" ] ; then
    ...
    FRESH_CLONE="/tmp/electrum_build/appimage/fresh_clone/electrum-brm"
...
docker run -it \
    ...
    -v "$PROJECT_ROOT_OR_FRESHCLONE_ROOT":/opt/electrum-brm \
    --rm \
    --workdir /opt/electrum-brm/contrib/build-linux/appimage \
