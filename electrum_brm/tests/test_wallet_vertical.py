...
from electrum_brm import storage, bitraam, keystore, bip32, slip39, wallet
from electrum_brm import Transaction
from electrum_brm import SimpleConfig
from electrum_brm import util
from electrum_brm.address_synchronizer import TX_HEIGHT_UNCONFIRMED, TX_HEIGHT_UNCONF_PARENT
from electrum_brm.wallet import (sweep, Multisig_Wallet, Standard_Wallet, Imported_Wallet,
...
from electrum_brm.util import bfh, NotEnoughFunds, UnrelatedTransactionException, UserFacingException
from electrum_brm.transaction import Transaction, PartialTxOutput, tx_from_any
from electrum_brm.mnemonic import seed_type
from electrum_brm.network import Network

from electrum_brm.plugins.trustedcoin import trustedcoin
...
class TestWalletSending(ElectrumTestCase):
    ...
    async def test_we_dont_sign_tx_including_dummy_address(self, mock_save_db):
        ...
        outputs = [PartialTxOutput.from_address_and_value(bitraam.DummyAddress.CHANNEL, 250000)]

        with self.assertRaises(bitraam.DummyAddressUsedInTxException):
            tx = wallet1.create_transaction(outputs=outputs, password=None, fee=5000, tx_version=1, rbf=False)
...
class TestWalletOfflineSigning(ElectrumTestCase):
    ...
    async def test_sending_offline_hd_multisig_online_addr_p2wsh_p2sh(self, mock_save_db):
        ...
        #               this switch is needed to interop with bitraam core... https://github.com/bitraam/bitraam/blob/fba574c908bb61eff1a0e83c935f3526ba9035f2/src/psbt.cpp#L163
