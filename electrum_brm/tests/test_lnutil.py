...
class TestLNUtil(ElectrumTestCase):
    ...
    def test_shachain_produce_consume(self):
        seed = bitraam.sha256(b"shachaintest")
    ...
    def test_commitment_tx_with_all_five_HTLCs_untrimmed_minimum_feerate(self):
        ...
        htlc[2] = make_offered_htlc(**htlc_pubkeys, payment_hash=bitraam.sha256(htlc_payment_preimage[2]))

        htlc_cltv_timeout[3] = 503
        htlc_payment_preimage[3] = b"\x03" * 32
        htlc[3] = make_offered_htlc(**htlc_pubkeys, payment_hash=bitraam.sha256(htlc_payment_preimage[3]))

        htlc_cltv_timeout[0] = 500
        htlc_payment_preimage[0] = b"\x00" * 32
        htlc[0] = make_received_htlc(**htlc_pubkeys, payment_hash=bitraam.sha256(htlc_payment_preimage[0]), cltv_abs=htlc_cltv_timeout[0])

        htlc_cltv_timeout[1] = 501
        htlc_payment_preimage[1] = b"\x01" * 32
        htlc[1] = make_received_htlc(**htlc_pubkeys, payment_hash=bitraam.sha256(htlc_payment_preimage[1]), cltv_abs=htlc_cltv_timeout[1])

        htlc_cltv_timeout[4] = 504
        htlc_payment_preimage[4] = b"\x04" * 32
        htlc[4] = make_received_htlc(**htlc_pubkeys, payment_hash=bitraam.sha256(htlc_payment_preimage[4]), cltv_abs=htlc_cltv_timeout[4])
        ...
        for num, msat in [(0, 1000 * 1000),
                          ...
                          (3, 3000 * 1000),
                          (4, 4000 * 1000)]:
            htlc_obj[num] = UpdateAddHtlc(amount_msat=msat, payment_hash=bitraam.sha256(htlc_payment_preimage[num]), cltv_abs=0, htlc_id=None, timestamp=0)
