...
from electrum_brm.wallet_db import WalletDBUpgrader, WalletDB, WalletRequiresUpgrade, WalletRequiresSplit
from electrum_brm.wallet import Wallet
...
##########
    ...
    plugins: 'electrum_brm.plugin.Plugins'
