...
from electrum_brm.util import make_dir, InvalidPassword, UserCancelled
from electrum_brm.gui.qt.util import (read_QIcon, EnterButton, WWLabel, icon_path,
                                  WindowModalDialog, Buttons, CloseButton, OkButton)
from electrum_brm.gui.qt.qrtextedit import ScanQRTextEdit
...
class Plugin(RevealerPlugin):
    ...
    def password_dialog(self, msg=None, parent=None):
        from electrum_brm.gui.qt.password_dialog import PasswordDialog
